#!/bin/bash
#
# Evaluate a LoRA-finetuned vision_r1 checkpoint (CoT format).
#
# Usage:
#   bash evaluation/lora_rl/eval_vision_r1_lora.sh <CHECKPOINT_PATH> [BASE_MODEL]
#
# Examples:
...
SAVE_DIR="./evaluation/responses/vision_r1_lora/${MODEL_NAME}/${STEP_NAME}"
