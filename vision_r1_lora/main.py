"""
Vision-R1 baseline training entry point (LoRA variant).

Standard GRPO training with accuracy-only reward on top of EasyR1.

Usage:
    python3 -m vision_r1_lora.main config=vision_r1_lora/config.yaml ...
"""
...
class Runner:
    """Runner for Vision-R1 baseline RL training."""
