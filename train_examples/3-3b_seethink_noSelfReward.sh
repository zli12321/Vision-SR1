...
python3 -m verl.trainer.main \
    config=train_examples/seethink_NoSelfReward.yaml \
    ...
    trainer.experiment_name=qwen2_5_vl_3b_NoSelfReward_grpo \
    trainer.save_checkpoint_path=./saves/3b_grpo_NoSelfReward \
