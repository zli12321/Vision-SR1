...
python3 -m vision_sr1_lora.main \
    config=vision_sr1_lora/config.yaml \
    ...
    trainer.experiment_name=qwen2_5_vl_7b_visionSR1_grpo_lora \
    trainer.save_checkpoint_path=./saves/7b_grpo_self_reward_lora \
